...
public class InterfaceScreen extends SGJourneyContainerScreen<InterfaceMenu>
{
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY)
    {
        ...
        this.renderEnergyVertical(pPoseStack, x + 162, y + 17, 6, 138, 176, 0, this.menu.getEnergy(), this.menu.getMaxEnergy());
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float delta)
    {
        ...
        this.commandEdit.render(poseStack, mouseX, mouseY, delta);
        
        renderTooltip(poseStack, mouseX, mouseY);
        
        this.tooltip(poseStack, mouseX, mouseY, 33, 16, 126, 20, ComponentHelper.energy("tooltip.sgjourney.energy_target", this.menu.getEnergyTarget()),
                ComponentHelper.description("tooltip.sgjourney.interface.energy_target.description"));
        this.energyTooltip(poseStack, mouseX, mouseY, 162, 17, 6, 138, "tooltip.sgjourney.energy_buffer", this.menu.getEnergy(), this.menu.getMaxEnergy());
        
        this.modeTooltip(poseStack, mouseX, mouseY, 9, 19, 16, 16,
    ...
    protected void renderLabels(PoseStack matrixStack, int mouseX, int mouseY)
	{
        ...
        this.font.draw(matrixStack, ComponentHelper.energy(menu.getEnergyBlockEnergy()), 20, 56, 0xffffff);
        this.font.draw(matrixStack, Component.translatable("info.sgjourney.open_time").append(":").withStyle(ChatFormatting.DARK_AQUA), 20, 66, 0xffffff);
        this.font.draw(matrixStack, ComponentHelper.tickTimer(menu.getStargateOpenTime(), SGJourneyStargate.MAX_OPEN_TIME, ChatFormatting.DARK_AQUA), 20, 76, 0xffffff);
        this.font.draw(matrixStack, Component.translatable("info.sgjourney.last_traveler_time").append(":").withStyle(ChatFormatting.DARK_PURPLE), 20, 86, 0xffffff);
        this.font.draw(matrixStack, Component.literal(Conversion.ticksToString(menu.getStargateTimeSinceLastTraveler())).withStyle(ChatFormatting.DARK_PURPLE), 20, 96, 0xffffff);
    }
}
