...
public class BlockInit
{
	...
	public static final RegistryObject<UnityClusterBlock> SMALL_UNITY_BUD = registerBlock("small_unity_bud",
			() -> new UnityClusterBlock(3, 4, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(1.5F).sound(SoundType.GLASS).requiresCorrectToolForDrops()));
	public static final RegistryObject<UnityClusterBlock> MEDIUM_UNITY_BUD = registerBlock("medium_unity_bud",
			() -> new UnityClusterBlock(4, 3, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(1.5F).sound(SoundType.GLASS).requiresCorrectToolForDrops()));
	public static final RegistryObject<UnityClusterBlock> LARGE_UNITY_BUD = registerBlock("large_unity_bud",
			() -> new UnityClusterBlock(5, 3, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(1.5F).sound(SoundType.GLASS).requiresCorrectToolForDrops()));
